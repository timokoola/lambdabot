...
./requests/utils.py
./requests-2.9.1-py2.7.egg-info/dependency_links.txt
./requests-2.9.1-py2.7.egg-info/installed-files.txt
./requests-2.9.1-py2.7.egg-info/not-zip-safe
./requests-2.9.1-py2.7.egg-info/PKG-INFO
./requests-2.9.1-py2.7.egg-info/requires.txt
./requests-2.9.1-py2.7.egg-info/SOURCES.txt
./requests-2.9.1-py2.7.egg-info/top_level.txt
./test.keys